...
public class ReviewController {
    ...
    @GetMapping(ApiPaths.PRODUCTS + "/{id}/reviews")
    ...
    @PostMapping(ApiPaths.PRODUCTS + "/{id}/reviews")
    ...
    @GetMapping(ApiPaths.PRODUCTS + "/{id}/reviews/summary")
    ...
    @GetMapping(ApiPaths.PRODUCTS + "/{id}/reviews/recent")
    ...
    @GetMapping(ApiPaths.PRODUCTS + "/{id}/reviews/helpful")
    ...
    @PostMapping("/reviews/{id}/not-helpful")
    ...
    @PostMapping("/reviews/moderate/bulk")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @GetMapping(ApiPaths.PRODUCTS + "/{id}/reviews/search")
