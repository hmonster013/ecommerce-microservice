...
public interface CacheService {
    ...
    class CacheHealthDto {
        ...
        public void setTotalCaches(int totalCaches) {
            this.totalCaches = totalCaches;
        }

        public int getHealthyCaches() {
            return healthyCaches;
        }

        public void setHealthyCaches(int healthyCaches) {
            this.healthyCaches = healthyCaches;
        }

        public int getUnhealthyCaches() {
            return unhealthyCaches;
        }

        public void setUnhealthyCaches(int unhealthyCaches) {
            this.unhealthyCaches = unhealthyCaches;
        }
