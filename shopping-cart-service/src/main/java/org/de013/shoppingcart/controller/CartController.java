...
public class CartController {
    ...
    @Operation(summary = "Clear cart", description = "Remove all items from the cart while keeping the cart structure intact. This action cannot be undone.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete cart", description = "Permanently delete the entire cart and all its items. This action cannot be undone.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Apply coupon", description = "Apply a discount coupon code to the cart. The coupon will be validated and discount applied if valid.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Remove coupon", description = "Remove the currently applied coupon from the cart and recalculate totals without discount.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Validate cart", description = "Perform comprehensive cart validation including item availability, pricing, and business rules. Returns validation results and any issues found.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Prepare checkout", description = "Prepare cart for checkout by validating items, calculating final totals, taxes, and shipping costs. Returns checkout summary with all necessary information for order creation.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update cart activity", description = "Update the last activity timestamp for the cart to prevent automatic expiration. Useful for keeping active carts alive during user sessions.")
    @ApiResponses(value = {
